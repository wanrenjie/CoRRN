...
checkpoint = torch.load("/home/model/model_J15.pth.tar")
...
for file in files:
	...
	for file2 in files2:
		...
		for file3 in files3:
			...
			img = Image.open(path+"/"+file+"/"+file2+"/"+file3+"/m.jpg")
			...
			outp.save(path+"/"+file+"/"+file2+"/"+file3+"/"+"our2.jpg")